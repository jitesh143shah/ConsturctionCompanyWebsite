    ...
    <>
      ...
      <div className="py-5 grid grid-cols-3 items-center justify-center  gap-5  container ">
        {ImagesLinks.map((data) => (
          <div className="bg-primary/50 flex flex-col items-center gap-5 hover:bg-primary/80
           group rounded-2xl duration-500 hover:text-white">
            ...
            />
           <span className="text-2xl group-hover:underline group-hover:duration-500 "> {data.name}</span>
