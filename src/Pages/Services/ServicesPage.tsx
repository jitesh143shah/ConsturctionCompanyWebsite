...
const ServicesPage = () => {
  ...
  <Navbar/>
   <div className="mb-5">
            <h1 className="capitalize text-center text-3xl md:text-4xl lg:text-7xl font-bold pb-12
           ...
           style={{ backgroundImage: `url(${building})  ` }}>
            <div className="flex items-center justify-center group hover:underline duration-500 gap-5 hover:text-primary" >
             ...
             <span className="group-hover:translate-y-15 duration-500 text-2xl md:text-4xl xl:text-5xl"><FaArrowDown/></span>
            </div>
            </h1>
          </div>
  <Services/>
